!(function () {
  ...
  class r extends React.Component {
    ...
    activatePad() {
      this.props.power
        ? "#007bff" === this.state.padStyle.backgroundColor
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            "DrumLab" + String.fromCharCode(160)
          ),
          React.createElement("i", {
            className: "inner-logo fas fa-drum",
          })
        ),
        React.createElement(
          "div",
